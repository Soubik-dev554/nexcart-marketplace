<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="NEXCART Logo" width="80" />
  <h1>NEXCART - Full-Stack MERN E-Commerce App</h1>
...
From the **root folder** `NEXCART/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@NEXCART.com` | Password: `password123`
...
This repository includes a fully-scaffolded API testing toolkit: **`NEXCART_Postman_Collection.json`**. 
